...
LParser::LSystem::LSystem(LSystem const&system) :
	alphabet(system.alphabet), drawfunction(system.drawfunction), angle(system.angle), replacementrules(system.replacementrules), nrIterations(system.nrIterations)
{
}
LParser::LSystem::~LSystem()
{
